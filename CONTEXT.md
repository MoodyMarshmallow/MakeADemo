...
- **Preparation Workspace Release**: The idempotent cleanup of a usable Daytona Repo Preparation workspace: active commands are cancelled, outbound network access is resealed, and both the primary Sandbox and its logical submitted-code child Sandbox are stopped then archived rather than deleted.
